...
//         :
//         <>
//         <motion.div style={{position:"fixed",backgroundColor:"rgb(255, 252, 240)",height:"100vh",padding:'1rem',overflowY:"scroll",width:is500?"100vw":"30rem",zIndex:500}}  variants={{show:{left:0},hide:{left:-500}}} initial={'hide'} transition={{ease:"easeInOut",duration:.7,type:"spring"}} animate={isProductFilterOpen===true?"show":"hide"}>
...
//                                 <ProductCard key={product._id} id={product._id} title={product.title} thumbnail={product.thumbnail} brand={product.brand.name} price={product.price} category={product?.category?.name} handleAddRemoveFromWishlist={handleAddRemoveFromWishlist}/>
//                             ))
//                         }
//                     </Grid>
